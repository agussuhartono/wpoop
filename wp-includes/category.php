 ...
 */
function get_category( $category, $output = wpdb::OBJECT, $filter = 'raw' ) {
 ...
 */
function get_category_by_path( $category_path, $full_match = true, $output = wpdb::OBJECT ) {
 ...
 */
function get_tag( $tag, $output = wpdb::OBJECT, $filter = 'raw' ) {
