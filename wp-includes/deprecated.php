 ...
 * @param string $output      Optional. Type of output. Accepts wpdb::OBJECT, wpdb::ARRAY_N, or wpdb::ARRAY_A.
 *                            Default wpdb::OBJECT.
 ...
 *
 * @param int $postid Post ID.
 * @param string $mode How to return result, either wpdb::OBJECT, wpdb::ARRAY_N, or wpdb::ARRAY_A.
